...
def main():     
        ...
        log_file = open(f'05_coverage_checks/{date_time}_log.txt', 'w')  
        ...
        for t in range(num_experim):  
                ...
                manu_fabr = pd.read_csv("01_data/source/manually_fabricated.csv", dtype=str, usecols=req_cols3)  
                ...
                out_df.to_csv(f'05_coverage_checks/{date_time}_{sample_size}_{int(class_perct)}_sample_coverage.csv', index=False)                
